...
//  void and(List<Map<String, dynamic>> values) {
//    _addExpression("\$and", values);
//  }
//
//  void or(List<Map<String, dynamic>> values) {
//    _addExpression("\$or", values);//values.map((e) => e.values).toList());
//  }
